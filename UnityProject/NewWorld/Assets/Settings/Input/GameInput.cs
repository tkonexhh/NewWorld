    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""95007e77-df0d-43ee-b4db-ffb008489460"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""372d8d00-8eb6-4d97-8f78-ad848e1dfd9a"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""KeyBoard"",
    ...
    ""controlSchemes"": [
        {
            ...
            m_Main_RotateCamera = m_Main.FindAction("RotateCamera", throwIfNotFound: true);
            ...
            m_Main_MouseControlCamera = m_Main.FindAction("MouseControlCamera", throwIfNotFound: true);
            // UI
        ...
        private readonly InputAction m_Main_RotateCamera;
        ...
        private readonly InputAction m_Main_MouseControlCamera;
        public struct MainActions
        {
            private @GameInput m_Wrapper;
            public MainActions(@GameInput wrapper) { m_Wrapper = wrapper; }
            public InputAction @RotateCamera => m_Wrapper.m_Main_RotateCamera;
            ...
            public InputAction @MouseControlCamera => m_Wrapper.m_Main_MouseControlCamera;
            ...
            public void SetCallbacks(IMainActions instance)
            {
                ...
                {
                    @RotateCamera.started -= m_Wrapper.m_MainActionsCallbackInterface.OnRotateCamera;
                    @RotateCamera.performed -= m_Wrapper.m_MainActionsCallbackInterface.OnRotateCamera;
                    @RotateCamera.canceled -= m_Wrapper.m_MainActionsCallbackInterface.OnRotateCamera;
                    ...
                    @MouseControlCamera.started -= m_Wrapper.m_MainActionsCallbackInterface.OnMouseControlCamera;
                    @MouseControlCamera.performed -= m_Wrapper.m_MainActionsCallbackInterface.OnMouseControlCamera;
                    @MouseControlCamera.canceled -= m_Wrapper.m_MainActionsCallbackInterface.OnMouseControlCamera;
                }
