...
namespace RPGCharacterAnims
{
    public class RPGCharacterInputController : MonoBehaviour
    {
        ...
        private void Inputs()
        {
            ...
            inputDeath = Input.GetKeyDown(KeyCode.F1);//Input.GetButtonDown("Death");
            inputAttackL = Input.GetKeyDown(KeyCode.H);//Input.GetButtonDown("AttackL");
            inputAttackR = Input.GetKeyDown(KeyCode.J);//Input.GetButtonDown("AttackR");
            inputCastL = Input.GetKeyDown(KeyCode.B);//Input.GetButtonDown("CastL");
            inputCastR = Input.GetKeyDown(KeyCode.N);//Input.GetButtonDown("CastR");
