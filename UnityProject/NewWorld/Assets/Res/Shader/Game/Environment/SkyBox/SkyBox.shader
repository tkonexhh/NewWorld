Shader "XHH/SkyBox"
{
    Properties
    {
        ...
        _SunRadius ("SunRadius", Range(1, 100)) = 80
        ...
        _MoonRadius ("MoonRadius", Range(1, 100)) = 90
        ...
        _CloudCutoff ("CloudCutoff", Range(0, 1)) = 0.03
        _CloudFuzziness ("CloudFuzziness", Range(0, 1)) = 0.1
