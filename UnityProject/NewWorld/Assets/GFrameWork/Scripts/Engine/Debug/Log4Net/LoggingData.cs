/************************
	FileName:/GFrameWork/Scripts/Engine/Debug/Log4Net/LoggingData.cs
	CreateAuthor:neo.xu
	CreateTime:3/1/2021 3:38:37 PM
	Tip:3/1/2021 3:38:37 PM
************************/
...
namespace GFrame.Debugger.Log4Net
{
    [Serializable]
    public class LoggingData : ISerializationCallbackReceiver
    {
        ...
        private LogLevel ConvertLevel(int value)
        {
            if (value <= 30000)
